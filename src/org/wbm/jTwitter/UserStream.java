...
import org.wbm.jTwitter.StatusProcessor.IStatusProcessor;
import twitter4j.*;
 ...
 */
public final class UserStream implements UserStreamListener {


//    private final IConsole console;
//    private final IURLProcessor urlProcessor;
    private final IStatusProcessor statusProcessor;

    public UserStream(IStatusProcessor statusProcessor) {
    ...
    public void Start() throws TwitterException {
        ...
        public void onStatus(Status status) {
            System.out.println("Got a status update" + status.getText().toString());
            statusProcessor.onStatus(status);
        }
